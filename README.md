...
On a Linux machine, run `bash tests/run.sh` before opening a pull request. Both test scripts should print a passed message. They use temporary directories and do not require root.
